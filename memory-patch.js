...
(function() {
    ...
    // Set memory configuration - increased for serialization demands
    window.Module.TOTAL_MEMORY = 3584 * 1024 * 1024;  // 3.5GB initial
    window.Module.TOTAL_STACK = 128 * 1024 * 1024;     // 128MB
    window.Module.INITIAL_MEMORY = 3584 * 1024 * 1024; // 3.5GB initial
    window.Module.MAXIMUM_MEMORY = 4096 * 1024 * 1024; // 4GB max (WASM32 limit)
